...
class BookTest {
	...
	void testIsKidFriendlyEligible() {
		...
		book = BookmarkService.getInstance().createBook(4000, "porn", 1854, "Wilder Publications",
				new String[] { "Henry David Thoreau" }, BookGenre.PHILOSOPHY, 4.3);
		assertFalse("\"porn\" in title, should return false", book.isKidFriendlyEligible());
		// Test 2: "porn" in publisher -- false
		book = BookmarkService.getInstance().createBook(4000, "Walden", 1854, "Porn Publications",
				new String[] { "Henry David Thoreau" }, BookGenre.PHILOSOPHY, 4.3);
